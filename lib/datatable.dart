...
class MyTable extends DataTableSource {
  ...
  List<Shop> _shops=<Shop>[
    ...
    Shop('三星66寸液晶智能电视2', 800, '家电', 20389.0,),
    Shop('三星66寸液晶智能电视3', 800, '家电', 20389.0,),
    Shop('三星66寸液晶智能电视4', 800, '家电', 20389.0,),
    Shop('三星66寸液晶智能电视5', 800, '家电', 20389.0,),
    Shop('三星66寸液晶智能电视6', 800, '家电', 20389.0,),
    Shop('三星66寸液晶智能电视7', 800, '家电', 20389.0,),
  ];

  @override
  DataRow getRow(int index) {
    if (index >= _shops.length || index < 0) throw FlutterError('行数出错了');
